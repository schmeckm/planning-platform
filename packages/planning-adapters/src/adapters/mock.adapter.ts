  ...
  async fetchOrders(): Promise<PlanningOrder[]> {
    ...
    return [
      // ─── Pharma Order 1: Feasible ───────────────────────────────────────
      {
        ...
        metadata: { previousMaterialId: 'MAT-BIO-001' },
        createdAt: base,
        updatedAt: base,
      },
      ...
      // ─── Pharma Order 4: TRIC blocked (batch not approved for JP) ─────────
      {
        id: asOrderId('ORD-PH-004'),
        externalId: 'SAP-100000004',
        sourceSystem: 'MOCK',
        materialId: asMaterialId('MAT-API-001'),
        batchId: asBatchId('BATCH-API-001'),
        quantity: 50,
        ...
        durationMinutes: 120,
        operations: [],
        tags: { campaign: 'CAMPAIGN-2024-EXPORT' },
      ...
      // ─── CGT Order 1: Feasible (matching patient IDs) ───────────────────
      {
        ...
        metadata: {
          ...
          courierPickupEarliest: daysFromNow(3).toISOString(),
          courierPickupLatest: daysFromNow(5).toISOString(),
        },
        createdAt: base,
        updatedAt: base,
      },
